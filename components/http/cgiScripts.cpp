...
static const tCGI CGIurls[NUM_CGIurls] = {
		...
		{ "/cgi-bin/getDayLogValues", (tCGIHandler_t) readCGIvalues, (CGIresponseFileHandler_t) getDayLogScript},
		{ "/cgi-bin/getHourLogValues", (tCGIHandler_t) readCGIvalues, (CGIresponseFileHandler_t) getHourLogScript},
